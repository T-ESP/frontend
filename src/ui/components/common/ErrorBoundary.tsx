    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-linear-to-br from-red-50 to-red-100 flex items-center justify-center p-4">
          <div className="max-w-4xl w-full bg-card rounded-lg shadow-2xl p-8">
            ...
            <div className="bg-red-500/10 border-l-4 border-red-500 p-4 mb-4 rounded">
              <h2 className="font-bold text-red-700 dark:text-red-300 mb-2">Error message:</h2>
            ...
            {this.state.errorInfo && (
              <div className="bg-muted border border-border rounded p-4 mb-6 max-h-96 overflow-auto">
                <h2 className="font-bold text-foreground mb-2">Stack trace:</h2>
            ...
            {this.state.error?.stack && (
              <details className="mb-6">
                <summary className="cursor-pointer font-semibold text-muted-foreground hover:text-foreground mb-2">
                  View full stack
                </summary>
                <div className="bg-gray-900 text-green-600 dark:text-green-400 rounded p-4 max-h-96 overflow-auto">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="bg-muted hover:bg-muted text-foreground font-semibold py-3 px-6 rounded-lg transition-colors"
              >
                Retour
              </button>
            </div>
