      ...
      <div className="space-y-10 w-full">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="p-6 bg-white border rounded-2xl border-slate-200">
                <h3 className="flex items-center gap-2 mb-4 font-bold text-slate-900">
                  <Package className="text-slate-400" size={18} />{t('inventory.kpi_modal.metrics.current_status')}
                </h3>
              ...
              <div className="p-6 bg-white border rounded-2xl border-slate-200">
                <h3 className="flex items-center gap-2 mb-4 font-bold text-slate-900">
                  <AlertTriangle className="text-slate-400" size={18} />{t('inventory.kpi_modal.metrics.stockout_analysis')}
                </h3>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="p-6 bg-white border rounded-2xl border-slate-200">
                <h3 className="flex items-center gap-2 mb-6 font-bold text-slate-900">
                  <Truck size={18} className="text-slate-400" />{t('inventory.kpi_modal.metrics.supply_chain')}
                </h3>
              ...
              <div className="p-6 border border-purple-200 bg-linear-to-br from-purple-50 to-indigo-50 rounded-2xl">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mb-4 text-sm text-slate-600">{t('inventory.kpi_modal.metrics.strategy_desc')}</p>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="p-3 bg-white/60 rounded-xl">
                        <p className="text-xs text-slate-600">{t('inventory.kpi_modal.metrics.frequency')}</p>
                        <p className="text-base font-bold text-slate-900">{t('inventory.kpi_modal.metrics.every')} {formatNum(kpis.restock.restock_frequency_days)} {t('inventory.kpi_modal.labels.days')}</p>
                      </div>
                      <div className="p-3 bg-white/60 rounded-xl">
                        <p className="text-xs text-slate-600">{t('inventory.kpi_modal.metrics.avg_cost')}</p>
                        <p className="text-base font-bold text-slate-900">{formatCurrency(kpis.restock.avg_restock_cost)}</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <section>
            ...
            <div className="relative p-8 overflow-hidden text-white bg-linear-to-br from-violet-500 via-purple-500 to-indigo-600 rounded-3xl mb-6">
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-white/20 backdrop-blur-sm rounded-xl"><Zap size={24} /></div>
                  <div>
        ...
        {kpis.comparative && (
          <section>
            ...
            <div className="p-6 bg-white border rounded-2xl border-slate-200 mb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="p-6 border bg-linear-to-br from-emerald-50 to-teal-50 rounded-2xl border-emerald-200">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 rounded-lg bg-emerald-100 text-emerald-600"><TrendingUp size={20} /></div>
              ...
              <div className="p-6 border border-purple-200 bg-linear-to-br from-purple-50 to-indigo-50 rounded-2xl">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 text-purple-600 bg-purple-100 rounded-lg"><Target size={20} /></div>
