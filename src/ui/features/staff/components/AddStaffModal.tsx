...
import type { CreateStaffDto } from "@/domain/models/Staff";
...
export function AddStaffModal({ isOpen, onClose, onStaffAdded }: AddStaffModalProps) {
  const [formData, setFormData] = useState<CreateStaffDto>(EMPTY_FORM);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Impossible de créer l'employé");
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="lea.dupont@example.com"
            />
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              À communiquer à l'employé pour sa première connexion.
            </p>
          </div>
