...
/** Carte conteneur homogène pour les widgets de la page Prédictions. */
export function PredictionCard({ title, subtitle, action, className = '', children }: PredictionCardProps) {
  return (
...
export function PredictionEmpty({ message }: { message: string }) {
  return (
