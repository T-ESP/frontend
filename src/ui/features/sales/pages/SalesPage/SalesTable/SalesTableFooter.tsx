export function SalesTableFooter() {
  return (
    <div className="flex justify-between items-center px-6 py-4 border-t border-border bg-gray-50/30">
      <p className="text-sm text-muted-foreground">
        Showing <span className="font-semibold text-foreground">1-5</span> of <span className="font-semibold text-foreground">124</span> deals
      </p>
