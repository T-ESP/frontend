  ...
  return (
    <div className="flex justify-between items-center px-6 py-5 from-gray-50 to-white border-b border-border bg-linear-to-r">
      ...
      <select 
        ...
        className="px-4 py-2 text-sm bg-card rounded-lg border border-border transition-all cursor-pointer outline-none focus:ring-2 focus:ring-primary focus:border-transparent hover:border-border"
      >
